-- Ida Efes — additional content tables (Blog, Site Settings, About Us, Legal pages)
...
-- are simply skipped.
INSERT IGNORE INTO blog_posts (slug, title, image, post_date, excerpt, content, sort_order) VALUES
...
INSERT IGNORE INTO site_settings (id, hotel_name, tagline, city, phone, email, address, check_in, check_out, front_desk_hours) VALUES
(1, 'Ida Efes', 'A few minutes from Ephesus', 'Selçuk, İzmir', '+90 000 000 00 00', 'reservations@idaefes.example', 'Selçuk, İzmir, Türkiye', '2:00 PM', '12:00 PM', 'Available 24 hours');

INSERT IGNORE INTO about_content (id, hero_title, hero_description, story_heading, story_paragraphs, team_image, value_blocks) VALUES
(1, 'A family project, twenty years in', 'From a six-room guesthouse to a small coastal hotel, built one season at a time.', 'How Ida Efes began',
...
INSERT IGNORE INTO legal_pages (slug, title, updated_label, sections) VALUES
