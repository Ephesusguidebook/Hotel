    ...
    <>
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {highlights.map((h) => (
              <div key={h.title} className="text-center px-2">
                ...
                <h3 className="mt-6 font-serif text-lg text-navy-900">
                  {h.title}
                </h3>
                <p className="mt-3 text-base text-navy-700 leading-relaxed">
                  {h.text}
                </p>
              </div>
            ))}
      ...
      <section className="bg-navy-950 py-24 px-6 lg:px-10">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-navy-700/40">
            {rooms.map((room) => (
        ...
        <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <SectionHeading
              ...
              description="Ida Efes opened as a six-room guesthouse and has grown slowly, one season at a time, without losing the parts that made it worth visiting in the first place."
            />
            <Link
              href="/about"
      ...
      {/* Add-ons teaser */}
      <section className="bg-navy-900 py-24 px-6 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <SectionHeading
          ...
          <div className="mt-12 text-center">
            <Link
              href="/add-ons"
              className="inline-flex items-center border border-gold-500 px-6 py-3 text-sm tracking-widest-plus text-gold-400 hover:bg-gold-500 hover:text-navy-950 transition-colors"
            >
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-10">
            {testimonials.map((t, i) => (
              <div key={i} className="text-center px-4">
                <p className="font-serif text-lg text-navy-900 leading-relaxed">
                  &ldquo;{t.quote}&rdquo;
                </p>
      ...
      <section className="relative py-28 px-6 lg:px-10">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <Link
            href="/rooms"
            className="mt-8 inline-flex items-center bg-gold-500 hover:bg-gold-400 text-navy-950 px-8 py-3.5 text-sm tracking-widest-plus transition-colors"
          >
            BOOK YOUR STAY
          </Link>
        </div>
