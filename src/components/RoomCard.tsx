  ...
  return (
    <div className="bg-charcoal-950">
      ...
      <div className="p-6">
        ...
        <p className="mt-2 text-sm tracking-wide text-ivory-200/60">
          {room.size} &middot; {room.occupancy} &middot; {room.bed}
        </p>
        <p className="mt-4 text-base text-ivory-200/80 leading-relaxed">
          {room.description}
        </p>
        <Link
          href={`/rooms#${room.slug}`}
          className="mt-5 inline-flex items-center gap-2 text-sm tracking-widest-plus text-gold-400 hover:text-gold-300"
        >
